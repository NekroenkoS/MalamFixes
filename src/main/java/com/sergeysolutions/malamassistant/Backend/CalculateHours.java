...
public class CalculateHours {
    ...
    private void calculateDifference() {
        ...
        if (differenceHours > 0 || differenceMinutes > 0) {
            ...
            MalamAssistantUi.getInstance().appendLog("You have completed the required hours.");
        }
    ...
    private void displayMessage(){
        ...
        MalamAssistantUi.getInstance().appendLog("Total work hours needed until today: " + totalWorkHoursNeeded + " hours and " + totalWorkMinutesNeeded + " minutes.");
        System.out.println("Total hours worked until today: " + myTotalWorkHours + " hours and " + myTotalWorkMinutes + " minutes.");
        MalamAssistantUi.getInstance().appendLog("Total hours worked until today: " + myTotalWorkHours + " hours and " + myTotalWorkMinutes + " minutes.");
    }
